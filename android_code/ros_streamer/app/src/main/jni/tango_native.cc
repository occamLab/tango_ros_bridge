...
static void onPointCloudAvailable(void* context, const TangoPointCloud* pointCloud) {
	LOGI("PAUL: got a point cloud");
	pthread_mutex_lock(&pointCloudLock);
	LOGI("POINT %f: %d", pointCloud->timestamp, pointCloud->num_points);
...
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_setBinder(JNIEnv * env , jobject obj, jobject
service )
{
...
JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_setupConfig(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_connectCallbacks(JNIEnv
* env,
jobject obj, jboolean streamColorImages)
{
...
JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_connect(JNIEnv* env,
jobject obj
)
{
TangoConnect();
...
JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_disconnect(JNIEnv
* env,
jobject obj
)
{
...
JNICALL Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_returnArrayColor(JNIEnv *env,
																						jobject This,
...
JNICALL Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_getPoses(
...
JNIEXPORT jbyteArray
JNICALL Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_returnArrayFisheye(
...
JNICALL Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_getColorFrameTimestamp(
...
JNICALL Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_getFisheyeFrameTimestamp(
		JNIEnv *env, jobject This) {
...
JNICALL Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_returnPoseArray(JNIEnv *env,
																					   jobject This) {
...
JNICALL Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_returnPoseAreaArray(
		JNIEnv *env, jobject This) {
	jdoubleArray poseDoubleArray = env->NewDoubleArray(10);
	pthread_mutex_lock(&areaPoseLock);
...
JNICALL Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_returnIntrinsicsColor(
		JNIEnv *env, jobject This) {
...
JNICALL Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_returnIntrinsicsFisheye(
		JNIEnv *env, jobject This) {
	double intrinsicsArray[11];
	jdoubleArray intrinsicsDoubleArray = env->NewDoubleArray(11);
	TangoCameraIntrinsics ccIntrinsics;
...
JNICALL Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_returnPointCloud(JNIEnv *env,
																						jobject This) {
	pthread_mutex_lock(&pointCloudLock);
